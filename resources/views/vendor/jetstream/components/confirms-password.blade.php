...
@once
    <x-jet-dialog-modal wire:model="confirmingPassword">
        ...
        <x-slot name="footer">
            <x-button-default type="submit" wire:click="stopConfirmingPassword" wire:loading.attr="disabled">
                {{ __('Cancel') }}
            </x-button-default>
            ...
            <x-button-default type="submit" class="ml-3" dusk="confirm-password-button" wire:click="confirmPassword"
