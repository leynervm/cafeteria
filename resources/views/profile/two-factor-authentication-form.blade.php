<x-jet-action-section>
    ...
    <x-slot name="content">
        <h3 class="text-sm font-medium text-textoprincipal">
            @if ($this->enabled)
        ...
        <div class="mt-3 max-w-xl text-xs text-colornavlink">
            <p>
        ...
        <div class="mt-5">
            @if (!$this->enabled)
                <x-jet-confirms-password wire:then="enableTwoFactorAuthentication">
                    <x-button-default wire:loading.attr="disabled">
                        {{ __('Enable') }}
                    </x-button-default>
            ...
            @else
                @if ($showingRecoveryCodes)
                    <x-jet-confirms-password wire:then="regenerateRecoveryCodes">
                        <x-button-default type="submit" class="mr-3">
                ...
                @elseif ($showingConfirmation)
                    <x-jet-confirms-password wire:then="confirmTwoFactorAuthentication">
                        <x-button-default class="mr-3" wire:loading.attr="disabled">
                            {{ __('Confirm') }}
                        </x-button-default>
