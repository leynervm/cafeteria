...
class ConvertAmountString
{

   public function convertString($xcifra, $moneda = '', $centimos = '')
   {
      $xarray = array(
      ...
      for ($xz = 0; $xz < 3; $xz++) {
         ...
         if (trim($xaux) != "") {
            switch ($xz) {
               ...
               case 2:
                  if ($xcifra < 1) {
                     $xcadena = "CERO " . strtoupper($moneda) . " Y $xdecimales/100 " . strtoupper($centimos);  // borrar en caso no se desee decimales /100
                  }
                  if ($xcifra >= 1 && $xcifra < 2) {
                     $xcadena = "UNO " . strtoupper($moneda) . " Y $xdecimales/100 " . strtoupper($centimos);   // borrar en caso no se desee decimales /100
                  }
                  if ($xcifra >= 2) {
                     $xcadena .= strtoupper($moneda) . " Y $xdecimales/100 " . strtoupper($centimos);  // borrar en caso no se desee decimales /100
                  }
                  break;
            } // endswitch ($xz)
         } // ENDIF (trim($xaux) != "")
